<form method="post" action="{{ route('profile.password.update') }}" novalidate>
    ...
    <div class="alert alert-light border mt-3 mb-0 d-flex align-items-center gap-2 py-2 px-3">
        ...
        <a href="https://wa.me/6285794190869?text=Halo%20Tim%20SPI%2C%20saya%20lupa%20password%20akun%20Sistem%20Audit%20Internal.%20Mohon%20bantuan%20reset%20akun%20saya.%20Terima%20kasih."
