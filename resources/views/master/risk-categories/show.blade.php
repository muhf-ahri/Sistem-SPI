...
<div class="card">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('master.risk-categories.edit', $riskCategory) }}" class="btn btn-sm btn-outline-primary" title="Edit" aria-label="Edit kategori risiko"><i class="bi bi-pencil"></i></a>
    </div>
    <div class="card-body">
        <x-detail-list>
