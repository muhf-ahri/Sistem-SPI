...
<div class="card">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0 text-primary">Formulir Edit Divisi</h5>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('master.divisions.update', $division) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-check mt-3">
                        ...
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $division->is_active) ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <button type="submit" class="btn btn-primary">Perbarui Divisi</button>
            </div>
        </form>
    </div>
</div>
