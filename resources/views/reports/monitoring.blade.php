...
@section('content')
<x-page-header title="Laporan Monitoring">
    <x-slot:breadcrumb>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('reports.monitoring') }}" class="row g-3">
            ...
            <div class="col-lg-3 col-12 d-flex justify-content-end align-items-end gap-2 ms-auto">
                ...
                <a href="{{ route('reports.monitoring') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        <h5 class="fw-bold mb-0 text-primary">Daftar Laporan Monitoring ({{ $reports->count() }})</h5>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-inline-flex gap-1">
                                    <a href="{{ route('monitoring-reports.download', $report) }}"
                                    ...
                                    @if(in_array(auth()->user()->role, ['spi', 'super_admin']))
                                        ...
                                        <x-confirm-modal
                                            ...
                                            :form-action="route('reports.monitoring.destroy', $report)"
                                        />
                                    @endif
                                </div>
                            </td>
